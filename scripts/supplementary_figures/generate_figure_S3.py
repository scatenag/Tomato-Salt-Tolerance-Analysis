#!/usr/bin/env python3
"""
Figure S3: Effect of salinity on Hormonal System

Heatmap showing pathway activity levels (Fold Change vs Control) across varieties
and treatments for Hormonal System parameters.
...
# Parameters for Figure S3: Hormonal System
FIGURE_PARAMS = [
    'ABA (ng/mg)',
    'GA4 (ng/mg)',
    'IAA (ng/mg)',
...
PARAM_DISPLAY_NAMES = {
    ...
    'IAA (ng/mg)': 'IAA (ng/mg)',
    'JA (ng/mg)': 'JA (ng/mg)',
    'Melatonin (ng/mg)': 'Melatonin (ng/mg)',
    'Metatopolin (ng/mg)': 'Metatopolin (ng/mg)',
    'SA (ng/mg)': 'SA (ng/mg)',
    'Z (ng/mg)': 'Z (ng/mg)'
}
...
def main():
    print("=" * 70)
    print("FIGURE S3: HORMONAL SYSTEM")
    print("=" * 70)
    ...
    # Title
    ax.set_title(f'Fig. S3: {FIGURE_TITLE}', fontsize=14, fontweight='bold', pad=15)
    ...
    png_path = output_dir / 'figure_S3_hormonal.png'
    fig.savefig(png_path, dpi=300, bbox_inches='tight', facecolor='white')
    print(f"\n✅ PNG: {png_path}")

    pdf_path = output_dir / 'figure_S3_hormonal.pdf'
