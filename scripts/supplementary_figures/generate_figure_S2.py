#!/usr/bin/env python3
"""
Figure S2: Effect of salinity on Primary/Secondary Metabolism

Heatmap showing pathway activity levels (Fold Change vs Control) across varieties
and treatments for Primary/Secondary Metabolism parameters.
...
# Parameters for Figure S2: Primary/Secondary Metabolism
FIGURE_PARAMS = [
...
PARAM_DISPLAY_NAMES = {
    'Antioxidant capacity (μmol Fe II/g FW)': 'Antioxidant capacity (μmol Fe II/g FW)',
    'Flavonoids (mg/g FW)': 'Flavonoids (mg/g FW)',
    'Lutein (μg/g FW)': 'Lutein (μg/g FW)',
    'Osmolytes (osm/kg)': 'Osmolytes (osm/kg)',
    'Phenols (mg/g FW)': 'Phenols (mg/g FW)',
    'Total chlorophyll (μg/g FW)': 'Total chlorophyll (μg/g FW)',
    'Violaxanthin (μg/g FW)': 'Violaxanthin (μg/g FW)'
}
...
# Figure title
FIGURE_TITLE = 'Primary/Secondary Metabolism'
...
def plot_heatmap(data_matrix, sig_matrix, ax):
    ...
    im = ax.imshow(data_matrix, cmap=cmap, aspect='auto', vmin=-1.5, vmax=1.5)
...
def main():
    print("=" * 70)
    print("FIGURE S2: PRIMARY/SECONDARY METABOLISM")
    print("=" * 70)
    ...
    # Title
    ax.set_title(f'Fig. S2: {FIGURE_TITLE}', fontsize=14, fontweight='bold', pad=15)
    ...
    png_path = output_dir / 'figure_S2_metabolism.png'
    fig.savefig(png_path, dpi=300, bbox_inches='tight', facecolor='white')
    print(f"\n✅ PNG: {png_path}")

    pdf_path = output_dir / 'figure_S2_metabolism.pdf'
